...
var wasmBinaryFile = 'grapheme.wasm';
...
var _grapheme_bigint_external_init = Module["_grapheme_bigint_external_init"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_grapheme_bigint_external_init"].apply(null, arguments)
};

var _grapheme_bigint_get_sign = Module["_grapheme_bigint_get_sign"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_grapheme_bigint_get_sign"].apply(null, arguments)
};

var _grapheme_bigint_get_word_count = Module["_grapheme_bigint_get_word_count"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_grapheme_bigint_get_word_count"].apply(null, arguments)
};

var _grapheme_bigint_get_words = Module["_grapheme_bigint_get_words"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var _grapheme_free_bigint = Module["_grapheme_free_bigint"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_grapheme_free_bigint"].apply(null, arguments)
};
